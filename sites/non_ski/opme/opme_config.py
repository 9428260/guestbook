...
class DevelopmentConfig(Config):
    ...
    OPMM_FILE_DOWNLOAD_PATH = 'D:/PythonProject/opme/files/opmm/download'
    OPME_FILE_EXPORT_PATH = 'D:/PythonProject/opme/files/opme/export'
...
class ProductionConfig(Config):
    ...
    # OPME Logging
    OPME_LOG_LOCATION = '/opme_data/home/opme/opme/logs/opme'
    ...
    # Interface Logging
    INTERFACE_LOG_LOCATION = '/opme_data/home/opme/opme/logs/opme'
    INTERFACE_LOG_FORMAT = '[%(levelname)s][%(asctime)s]%(message)s'
    INTERFACE_LOG_LEVEL = logging.INFO  # DEBUG, INFO, WARNING, ERROR, CRITICAL
    INTERFACE_LOG_FILENAME = 'interface.log'
    INTERFACE_LOG_MAX_BYTES = 1024 * 1024 * 10  # 10M
    ...
    # OPMM REST API URL
    OPMM_REST_API_URL = 'https://10.1.4.164:8443/opmate/v2.0'
    # File Download(from OPMM)
    OPMM_FILE_DOWNLOAD_PATH = '/opme_data/home/opme/opme/files/opmm/downloads'
    OPME_FILE_EXPORT_PATH = '/opme_data/home/opme/opme/files/opme/export'
