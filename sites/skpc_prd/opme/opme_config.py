...
class Config(object):
    SITE_NAME = '[PRD] SK OPMATE on SKPC'
...
class ProductionConfig(Config):
    ...
    # OPME Logging
    OPME_LOG_LOCATION = '/opme_data/home/opme/opme_mfg/logs/opme'
    ...
    # Interface Logging
    INTERFACE_LOG_LOCATION = '/opme_data/home/opme/opme_skpc/logs/opme'
    INTERFACE_LOG_FORMAT = '[%(levelname)s][%(asctime)s]%(message)s'
    INTERFACE_LOG_LEVEL = logging.INFO  # DEBUG, INFO, WARNING, ERROR, CRITICAL
    INTERFACE_LOG_FILENAME = 'interface.log'
    INTERFACE_LOG_MAX_BYTES = 1024 * 1024 * 10  # 10M
    ...
    # OPMM REST API URL
    OPMM_REST_API_URL = 'https://10.192.11.135:8443/opmate/v2.0'
    # File Download(from OPMM)
    OPMM_FILE_DOWNLOAD_PATH = '/opme_data/home/opme/opme_skpc/files/opmm/downloads'
    OPME_FILE_EXPORT_PATH = '/opme_data/home/opme/opme_skpc/files/opme/export'
