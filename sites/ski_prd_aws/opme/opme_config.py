...
class ProductionConfig(Config):
    ...
    # OPME Logging
    OPME_LOG_LOCATION = '/opme_data/home/opme/opme_ski/logs/opme'
    ...
    # Interface Logging
    INTERFACE_LOG_LOCATION = '/opme_data/home/opme/opme_ski/logs/opme'
    INTERFACE_LOG_FORMAT = '[%(levelname)s][%(asctime)s]%(message)s'
    INTERFACE_LOG_LEVEL = logging.INFO  # DEBUG, INFO, WARNING, ERROR, CRITICAL
    INTERFACE_LOG_FILENAME = 'interface.log'
    INTERFACE_LOG_MAX_BYTES = 1024 * 1024 * 10  # 10M
    ...
    # File Download(from OPMM)
    OPMM_FILE_DOWNLOAD_PATH = '/opme_data/home/opme/opme_ski/files/opmm/downloads'
    OPME_FILE_EXPORT_PATH = '/opme_data/home/opme/opme_ski/files/opme/export'
