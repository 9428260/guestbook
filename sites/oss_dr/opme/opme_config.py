...
class Config(object):
    SITE_NAME = 'OSS DR'
    OPME_VERSION = 'v20240703'
    OPMM_MIN_VERSION = 'OPMM Version 2.0.301'
    OPMM_MAX_VERSION = 'OPMM Version 2.0.303'
    DEBUG = False
    ...
    OPMM_TCS_VERIFY_ENABLE = 'no'  # OPMM TCS 활성화 여부 yes : 활성화, no : 비활성화
...
class ProductionConfig(Config):
    ...
    # OPMM REST API URL
    OPMM_REST_API_URL = 'https://150.24.251.173:8443/opmate/v2.0'
    # File Download(from OPMM)
