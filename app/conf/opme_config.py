...
class Config(object):
    ...
    OPMM_MAX_VERSION = 'OPMM Version 2.0.324'
    DEBUG = False
    ...
    NOTILIST_CONDITION = [{'value': 'success', 'text': '성공'},
                          {'value': 'fail', 'text': '실패'}]
...
class DevelopmentConfig(Config):
    ...
    if platform.system() == 'Windows':
        OPME_LOG_LOCATION = 'D:/PycharmProjects/opme/logs'
        INTERFACE_LOG_LOCATION = 'D:/PycharmProjects/opme/logs'
        # File Download(from OPMM)
        OPMM_FILE_DOWNLOAD_PATH = 'D:/PycharmProjects/opme/files/opmm/download'
        OPME_FILE_EXPORT_PATH = 'D:/PycharmProjects/opme/files/opme/export'
    else:  # macOS, Linux 등
        project_root = os.path.dirname(os.path.dirname(basedir))  # app/conf/../.. = project root
        OPME_LOG_LOCATION = os.path.join(project_root, 'logs')
        INTERFACE_LOG_LOCATION = os.path.join(project_root, 'logs')
        # File Download(from OPMM)
        OPMM_FILE_DOWNLOAD_PATH = os.path.join(project_root, 'files/opmm/download')
        OPME_FILE_EXPORT_PATH = os.path.join(project_root, 'files/opme/export')
    ...
    # OPMM REST API URL
    #OPMM_REST_API_URL = 'https://192.168.56.81:8443/opmate/v2.0' # vm1
    OPMM_REST_API_URL = 'https://13.209.68.195:8443/opmate/v2.0' # testbed
    #OPMM_REST_API_URL = 'https://192.168.56.101:8443/opmate/v2.0' # vm2
...
class ProductionConfig(Config):
    ...
    # File Download(from OPMM)
    OPMM_FILE_DOWNLOAD_PATH = '/home/opme/opme/files/opmm/downloads'
